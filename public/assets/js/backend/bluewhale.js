define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'bluewhale/index' + location.search,
                    add_url: 'bluewhale/add',
                    edit_url: 'bluewhale/edit',
                    del_url: 'bluewhale/del',
                    multi_url: 'bluewhale/multi',
                    table: 'bluewhale'
                }
            });
            ...
            $('#create-group').on('click',function(){
                Fast.api.open("/admin/bluewhale/add", __('Add'),{
            ...
            $('body').on('click','.icon-cc-edit',function(){
                ...
                var name = 'name_'+id;
                Fast.api.open("/admin/bluewhale/edit?ids="+$(this).attr('data-id'), __('Edit'), {
                    callback:function(value){
            ...
            $('body').on("click",'.icon-cc-del', function (e) {
                    ...
                    Layer.confirm(
                        ...
                        function (index) {
                            Fast.api.ajax({
                                url:"/admin/bluewhale/del/ids/"+id,
                            }, function (data, ret) {
                                Layer.close(index);
